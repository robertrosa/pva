...
$ora_sql = "select distinct a.attribute_type, b.attribute_type_desc, b.csa_flag from mt1360 a, mt0340 b
        where a.reporting_field = " . $rfnum . "
        and a.attribute_type = b.attribute_type
        union
        select distinct a.csa_type, b.attribute_type_desc, b.csa_flag from mt1060 a, mt0340 b
        where a.reporting_field = " . $rfnum . "
        and a.csa_type = b.attribute_type
        Union
        select distinct a.attribute_type, b.attribute_type_desc, b.csa_flag from mt1340 a, mt0340 b
...
while ($result = odbc_fetch_array($results)) {
  echo '<option value="' . $result['attribute_type'] . '">' . $result['attribute_type'] . ' ' . $result['attribute_type_desc'] . '</option>';
}
