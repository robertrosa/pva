...
// Get volume fields for chosen rfNum from oracle db. Returning 'NOM_WEIGHT' in case we want to use it at any point bu tmay not be needed
...
while ($result = odbc_fetch_array($results)) {
    echo '<option value="' . $result['NOM_WEIGHT_DESC'] . '">' . $result['NOM_WEIGHT_DESC'] . '</option>';
}
